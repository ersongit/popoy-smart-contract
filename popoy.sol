...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD3641db797957Fea9f45109Cf7B5BEf4e0e54e6b;
...
contract POPOYToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE4Bd429DDa78A8B8b4b872E8b852beF5A6c0Bcc0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "POPOY";
    string private _symbol = "POPOY";
